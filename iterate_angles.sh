...
counter=0
for i in $(seq 15.0 0.001 15.5); do
    echo $i
    ...
    rm "../790831_${padded_num}.tcode"
    gs -sDEVICE=pdfwrite -dEPSCrop -o 790831_${padded_num}.pdf 790831_${padded_num}.eps
    rm "790831_${padded_num}.eps"
    cpdf -scale-page "0.2 0.2" 790831_${padded_num}.pdf -o 790831_${padded_num}_rescaled.pdf
